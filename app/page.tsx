      ...
      <div className="min-h-screen bg-white">
        ...
        <style dangerouslySetInnerHTML={{
          __html: `
            ...
            @keyframes logo-glow {
              0%, 100% {
                filter: drop-shadow(0 0 3px rgba(220, 38, 127, 0.2));
              }
              50% {
            ...
            .logo-hover-effect:hover {
              ...
              filter: drop-shadow(0 4px 8px rgba(220, 38, 127, 0.2));
            }
          `
        }} />
              ...
              <div className="flex items-center space-x-4">
                ...
                <div className="relative">
                  <img 
                    ...
                    className="h-10 w-10 rounded-full object-cover bg-white p-1 shadow-sm logo-hover-effect animate-logo-glow"
                  />
                  {/* Animated ring around logo */}
                  <div className="absolute -inset-1 border border-pink-200 rounded-full opacity-30 animate-logo-pulse"></div>
                </div>
            ...
            <div className="text-center mb-16">
              ...
              <div className="flex justify-center mb-6">
                <img 
                  src="/logo.png" 
                  alt="STAAJ Solutions" 
                  className="h-12 w-12 rounded-full object-cover bg-white p-1 shadow-sm animate-logo-bounce opacity-90"
                />
              </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex justify-center items-center space-x-3">
              ...
              <img 
                src="/logo.png" 
                alt="STAAJ Solutions" 
                className="h-8 w-8 rounded-full object-cover bg-white p-1 shadow-sm opacity-90 hover:opacity-100 transition-opacity duration-300"
              />
